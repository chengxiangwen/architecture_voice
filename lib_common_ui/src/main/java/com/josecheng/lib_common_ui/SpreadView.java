package com.josecheng.lib_common_ui;
...
public class SpreadView extends View {
    ...
    public SpreadView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int centerColer = a.getColor(R.styleable.SpreadView_spread_center_color,
                ContextCompat.getColor(context,android.R.color.holo_red_dark));
        int speadColor = a.getColor(R.styleable.SpreadView_spread_spread_color,
        ...
        centerPaint.setColor(centerColer);
        //最开始不透明且扩散距离为0
        alphas.add(255);
        spreadRadius.add(0);
        ...
        spreadPaint.setColor(speadColor);
        spreadPaint.setAlpha(0);
